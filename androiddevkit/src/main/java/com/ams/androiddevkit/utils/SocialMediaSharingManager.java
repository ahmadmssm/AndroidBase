...
public class SocialMediaSharingManager {
    ...
    public static class Builder {
        ...
        public Builder (Context ctx) { this.ctx = ctx; }
        ...
        public SocialMediaSharingManager build() { return new SocialMediaSharingManager(this); }
    }

    //private constructor to enforce object creation through builder
    private SocialMediaSharingManager(Builder builder) {
